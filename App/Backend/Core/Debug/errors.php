...
function kristal_errorOutput($label, $message, $file, $line): void
{
    ...
    if (!PRODUCTION_MODE)
    {
        require WEBROOT . "/App/Backend/Core/Debug/Templates/warningOutput.php";
    }
}
...
{
    require WEBROOT . "/App/Backend/Core/Debug/Templates/ProductionFatalErrorOutput.php";
}
...
function kristal_fatalErrorOutput($message, $file, $line): void
{
    ...
    require WEBROOT . "/App/Backend/Core/Debug/Templates/fatalErrorOutput.php";
}
